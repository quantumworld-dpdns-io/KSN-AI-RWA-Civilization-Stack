...
class RemoteConnection {
    constructor(opts) {
        ...
        this._client = new client_1.HttpLancedbClient(server, opts.apiKey, opts.timeout, opts.hostOverride === undefined ? undefined : this._dbName);
    }
    get uri() {
...
class RemoteTable {
    ...
    async indexStats(indexName) {
        const results = await this._client.post(`/v1/table/${encodeURIComponent(this._name)}/index/${indexName}/stats/`);
