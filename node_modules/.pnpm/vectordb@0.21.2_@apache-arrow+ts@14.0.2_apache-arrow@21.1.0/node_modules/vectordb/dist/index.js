...
class LocalTable {
    ...
    async add(data) {
        ...
        if (data instanceof apache_arrow_1.Table) {
            ...
            tbl = (0, arrow_1.makeArrowTable)(data, { schema, embeddings: this._embeddings });
        }
        return tableAdd
    ...
    async mergeInsert(on, data, args) {
        ...
        if (args.whenMatchedUpdateAll !== undefined &&
        ...
        if (args.whenNotMatchedBySourceDelete !== undefined &&
